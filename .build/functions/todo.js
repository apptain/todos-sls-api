...
var DB_PREFIX = process.env.IS_OFFLINE ? "dev" : process.env.DB_PREFIX;
...
function createTodo(event, context) {
...
;
function getAllTodos(event, context) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            db("scan", {
                TableName: DB_PREFIX + "-todos"
            }).then(function (todos) {
                return response_lib_1.success(todos);
            })
                .catch(function (err) {
                return response_lib_1.failure({ status: false });
            });
...
;
function updateTodo(event, context) {
    return __awaiter(this, void 0, void 0, function () {
        var data;
        return __generator(this, function (_a) {
            data = JSON.parse(event.body);
...
;
function deleteTodo(event, context) {
    return __awaiter(this, void 0, void 0, function () {
        var id;
        return __generator(this, function (_a) {
